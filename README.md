...
6. 5.1 View detail product item 2
7. 5.2 Call api get *{host}/GetProductById/{productId}*  
8. ....http://localhost:8080/GetProductById/2   - 
9. Add product to basket
